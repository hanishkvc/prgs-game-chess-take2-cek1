...
DBG_OPTS=${BASE_OPTS} ${DBG_MISCOPTS} ${DBG_ADDOPTS}
...
cek1: cek1.c cek1.h moves.c evals.c generate_movebbs.c positioncmd.c positionhash.c
	...
	gcc -Wall -O2 -o cek1_fastmtab cek1.c -D_GNU_SOURCE -DCORRECTVALFOR_SIDETOMOVE ${FASTAB_OPTS} -DUSE_THREAD -lpthread
	gcc -Wall -g -o cek1_fastmtabxg cek1.c -D_GNU_SOURCE -DCORRECTVALFOR_SIDETOMOVE ${DBG_OPTS} ${FASTAB_OPTS} -DUSE_THREAD -lpthread
